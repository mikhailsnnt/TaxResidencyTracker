...
import mikhailsnnt.taxresident.lib.cor.ICorExec
import mikhailsnnt.taxresident.lib.cor.ICorExecDsl
...
abstract class AbstractICorExec<T>(
    ...
    private suspend fun except(context: T, throwable: Throwable) = context.blockExcept(throwable)
...
abstract class CorExecDsl<T> : ICorExecDsl<T> {
    ...
    protected var blockExcept: suspend T.(Throwable) -> Unit = { }
